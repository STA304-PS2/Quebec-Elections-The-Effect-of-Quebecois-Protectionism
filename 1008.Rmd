...
Through various figures and tables, such as showcasing voting intention based upon the respondent’s view on the importance of protecting Quebecois culture, our hypothesis — Quebecers find protecting their culture is a predictor for how likely they are to vote for the Bloc Quebecois — was repeatedly proven false. 
...
The results we found are important because they help the Liberal party prepare for the next election. Because we are surveying individuals in Quebec only a year after the last federal election, the Liberal Party can have a head start in changing its platform to cater to the lost seats in Quebec. 
...
Based on contemporary services, we expect to spend a total of $180,000 on 200,000 mail surveys. With each survey costing approximately $0.90, multiplied by the amount of mail surveys we plan to send, 200 000, we arrive at a cost of $180,000. Based on (https://simpletexting.com/pricing/), we plan to spend a total of $3,750 on SMS text surveys. Since 50,000 surveys cost $625 and we would like to send out 300,000 surveys, we will spend a total of $625*6=$3,750 on SMS text surveys. This results in a combined cost of $183,750 for administering the survey. To incentivize respondents, we are also including prizes for completing the survey, and we estimate that to cost approximately $1,250, bringing us to a total estimate of $185,000. 

When arriving at an estimate of $185,000, we were cognizant of the fact that we are employed by the Liberty Party of Canada — the oldest federal party in Canada —making it more likely for our survey to be funded.  When arriving at the estimate of $185,000, we also decided to cut costs by reducing the amount of mail surveys by 50,000 in order to cut costs.  
